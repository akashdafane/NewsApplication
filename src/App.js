  ...
  return (
    <div className="App">
      ...
      <Switch>
        ...
        <PublicRoute path="/ListFormData" component={ListFormData} {...props} exact />
        {/* <Route path="/Dashboard" component={Dashboard} {...props} /> */}
        <PublicRoute path="/Fetchuser" component={FetchUser} {...props} exact />
        <PublicRoute path="/Formikform" component={FormikForm} {...props} exact />
        <PublicRoute path="/FetchData" component={FetchData} {...props} exact />
        <PublicRoute path="/Increment" component={Increment}{...props} exact />
        <PublicRoute path="/UserFilter" component={UserFilter} {...props} exact />
        <PublicRoute path="/Posts" component={Posts} {...props} exact />
        <PublicRoute path="/SectionwiseAverage" component={SectionwiseAverage} {...props} exact />
        <PublicRoute path="/Demo" component={Demo} {...props} exact />
        <PublicRoute path="/SectionB" component={SectionB} {...props} exact />
        <PublicRoute path="/LocalStorage" component={LocalStorage} {...props} exact />
        <PublicRoute path="/Dbounce" component={Dbounce} {...props} exact />
        <PublicRoute path="/ParentComponent" component={ParentComponent} {...props} exact />
        <PublicRoute path="/FieldArr" component={FieldArr} {...props} exact />
        <PublicRoute path="/FieldArrayList" component={FieldArrayList} {...props} exact />
        <PublicRoute path="/AverageofSectionB" component={AverageofSectionB} {...props} exact />
